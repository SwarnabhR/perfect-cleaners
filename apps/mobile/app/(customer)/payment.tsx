...
export default function PaymentSheet() {
  ...
  // Icons built inside component so they pick up theme-aware c.fg2
  const METHOD_ICONS: Record<string, React.ReactNode> = {
    upi:        <Droplet    size={16} color={c.fg2} strokeWidth={1.5} />,
    card:       <CreditCard size={16} color={c.fg2} strokeWidth={1.5} />,
    netbanking: <Wallet     size={16} color={c.fg2} strokeWidth={1.5} />,
    wallet:     <Wallet     size={16} color={c.fg2} strokeWidth={1.5} />,
  };
  ...
  const s = StyleSheet.create({
    ...
    handle: {
      ...
      backgroundColor: c.lineStrong, alignSelf: 'center', marginBottom: spacing[4],
    },
    ...
    razorpayInfo: { flex: 1 },
    razorpayLabel: {
      fontFamily: typography.mono, fontSize: 9, color: c.fg3,
      letterSpacing: 1, textTransform: 'uppercase',
    },
    razorpayMerchant: {
      fontFamily: typography.sansMedium, fontSize: 13, color: c.fg,
    },
    closeBtn: {
    ...
    orderLabel:     { fontFamily: typography.sans, fontSize: 13, color: c.fg2 },
    orderCode:      { fontFamily: typography.sans, fontSize: 12, color: c.fg3 },
    orderDiscount:  { fontFamily: typography.sans, fontSize: 12, color: c.sageHi },
    orderDivider:   { height: 1, backgroundColor: c.line, marginVertical: spacing[1] },
    orderTotalLabel:{ fontFamily: typography.sansMedium, fontSize: 13, color: c.fg },
    orderTotal:     { fontFamily: typography.serif, fontSize: typography['2xl'], color: c.fg, letterSpacing: -0.1 },
    ...
    methodCardActive: { backgroundColor: c.cardHi, borderColor: c.lineStrong },
    methodIconBox: {
    ...
    methodInfo:  { flex: 1 },
    methodLabel: { fontFamily: typography.sansMedium, fontSize: 14, color: c.fg },
    methodSub:   { fontFamily: typography.sans, fontSize: 11.5, color: c.fg2, marginTop: 1 },
    radio: {
      width: 18, height: 18, borderRadius: 999,
      borderWidth: 1, borderColor: c.lineStrong,
      alignItems: 'center', justifyContent: 'center',
    },
    radioActive: { borderColor: c.warm, backgroundColor: c.warm },
    radioDot:    { width: 6, height: 6, borderRadius: 999, backgroundColor: c.ink },
    ...
    upiCardActive: { backgroundColor: c.cardHi, borderColor: c.lineStrong },
    upiIcon: {
      width: 44, height: 44, borderRadius: 9,
      alignItems: 'center', justifyContent: 'center',
    },
    upiIconText: { fontFamily: typography.sansBold, fontSize: 13, color: '#fff' },
    upiLabel:    { fontFamily: typography.mono, fontSize: 9, color: c.fg2, letterSpacing: 0.6 },
    upiInputRow: {
      flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: spacing[1],
      backgroundColor: c.card, borderWidth: 1, borderColor: c.line,
      borderRadius: 12, paddingVertical: 12, paddingHorizontal: 14,
    },
    upiInputText:  { flex: 1, fontFamily: typography.mono, fontSize: 14, color: c.fg, letterSpacing: 0.4 },
    upiInputCheck: {
    ...
    cardNumber: { flex: 1, fontFamily: typography.mono, fontSize: 14, color: c.fg, letterSpacing: 1.8 },
    cardBrand: {
      backgroundColor: c.ink, borderRadius: 4, paddingHorizontal: 8, paddingVertical: 4,
    },
    ...
    secureText: {
      fontFamily: typography.mono, fontSize: 10, color: c.fg3, letterSpacing: 0.6,
    },
  });
  ...
  async function handlePay() {
    ...
    const options: CheckoutOptions = {
      ...
      theme: {
        // Always dark for Razorpay overlay regardless of app theme
        color:          colors.sage,
