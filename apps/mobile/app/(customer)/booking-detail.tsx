...
// Demo booking data keyed by booking ID
...
export default function BookingDetailScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Before / After teaser (only for completed) */}
      {isCompleted ? (
...
const s = StyleSheet.create({
  ...
  primaryBtnText: {
    ...
    fontSize: 13, color: colors.ink, letterSpacing: 0.6,
  },
  ghostBtn: {
    borderRadius: radii.pill,
    paddingVertical: 13,
  ...
  ghostBtnText: {
    ...
    fontSize: 13, color: colors.fg, letterSpacing: 0.6,
  },
});
