    ...
    >
      ...
      <View style={{ paddingTop: insets.top }}>
        ...
        <TouchableOpacity style={s.bell}>
          <Bell size={18} color={colors.fg2} strokeWidth={1.5} />
        </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={s.statStrip}>
        ...
        <View style={[s.statCard, { borderLeftWidth: 1, borderLeftColor: colors.line }]}>
        ...
        {SERVICES.map(svc => (
          ...
          >
            ...
            <View style={s.serviceDurationRow}>
              <Clock size={11} color={colors.fg4} strokeWidth={1.5} />
      ...
      <View style={s.uspGrid}>
        {USPS.map(({ icon: Icon, label }) => (
          <View key={label} style={[s.uspCard, { width: (SW - spacing[6] * 2 - 8) / 2 }]}>
            <Icon size={20} color={colors.sage} strokeWidth={1.5} />
...
const s = StyleSheet.create({
  ...
  heroBtnPrimaryText: { fontFamily: typography.sansSemiBold, fontSize: typography.sm, color: colors.ink },
  heroBtnGhost: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: 'transparent', borderWidth: 1, borderColor: colors.lineStrong,
  ...
  statStrip: {
    ...
    borderWidth: 1, borderColor: colors.line, marginBottom: spacing[8],
  },
  statCard: { flex: 1, paddingVertical: spacing[4], alignItems: 'center', gap: 2 },
  statValue: { fontFamily: typography.serif, fontSize: typography['2xl'], color: colors.fg, letterSpacing: -0.5 },
  statLabel: { fontFamily: typography.sans, fontSize: 11, color: colors.fg3, textTransform: 'uppercase', letterSpacing: 0.8 },

  section: { paddingHorizontal: spacing[6], marginBottom: spacing[4] },
  eyebrow: { fontFamily: typography.sans, fontSize: 10, color: colors.fg3, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 },
  sectionTitle: { fontFamily: typography.sansMedium, fontSize: typography.xl, color: colors.fg, letterSpacing: -0.3 },
  ...
  serviceNum: { fontFamily: typography.mono, fontSize: typography.xs, color: colors.fg4 },
  serviceMeta: { flex: 1 },
  serviceName: { fontFamily: typography.sansMedium, fontSize: typography.base, color: colors.fg },
  servicePrice: { fontFamily: typography.sans, fontSize: typography.xs, color: colors.sage },
  serviceBody: { fontFamily: typography.sans, fontSize: typography.sm, color: colors.fg3, lineHeight: 20 },
  serviceDurationRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  serviceDuration: { fontFamily: typography.sans, fontSize: 11, color: colors.fg4 },

  premiumBanner: {
    marginHorizontal: spacing[6], backgroundColor: colors.sageLo,
    borderRadius: radii.xl, padding: spacing[6],
    marginBottom: spacing[8], gap: 12,
    borderWidth: 1, borderColor: colors.sage + '40',
  },
  premiumEye: { fontFamily: typography.sans, fontSize: 10, color: colors.sageInk + 'AA', letterSpacing: 2, textTransform: 'uppercase' },
  premiumTitle: { fontFamily: typography.serif, fontSize: typography['2xl'], color: colors.sageInk, letterSpacing: -0.3, lineHeight: 34 },
  premiumBody: { fontFamily: typography.sans, fontSize: typography.sm, color: colors.sageInk + 'BB', lineHeight: 20 },
  premiumBtn: {
    alignSelf: 'flex-start',
    borderWidth: 1, borderColor: colors.sageInk + '60',
    borderRadius: radii.pill, paddingHorizontal: spacing[5], paddingVertical: 10,
  },
  premiumBtnText: { fontFamily: typography.sansMedium, fontSize: typography.sm, color: colors.sageInk },
  ...
  uspCard: {
    // width set inline via useWindowDimensions so it reacts to screen size changes
    backgroundColor: colors.card, borderWidth: 1, borderColor: colors.line,
    borderRadius: radii.md, padding: spacing[4], gap: 8,
  },
  uspLabel: { fontFamily: typography.sansMedium, fontSize: typography.sm, color: colors.fg2 },
  ...
  ctaTitle: { fontFamily: typography.serif, fontSize: typography['2xl'], color: colors.fg, textAlign: 'center' },
  ctaBtn: {
    backgroundColor: colors.warm, borderRadius: radii.pill,
    paddingHorizontal: spacing[8], paddingVertical: 14,
  },
  ctaBtnText: { fontFamily: typography.sansSemiBold, fontSize: typography.base, color: colors.ink },
});
