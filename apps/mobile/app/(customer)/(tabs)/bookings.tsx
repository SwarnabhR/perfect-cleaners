  ...
  return (
    <View style={s.empty}>
      ...
      <View style={s.emptyIcon}>
        <Car size={26} color={colors.fg2} strokeWidth={1.5} />
      </View>
...
const s = StyleSheet.create({
  ...
  cardId: {
    fontFamily: typography.mono, fontSize: 9.5, color: colors.fg3, letterSpacing: 0.8,
  },
  cardService: {
    fontFamily: typography.sansMedium, fontSize: 14, color: colors.fg, letterSpacing: -0.1,
  },
  cardMeta: {
    fontFamily: typography.sans, fontSize: 11.5, color: colors.fg2, marginTop: 2,
  },
  cardRight: { alignItems: 'flex-end', gap: 4, flexShrink: 0 },
  cardPrice: {
    fontFamily: typography.serif, fontSize: 17, color: colors.fg,
  },
  cardArrow: {
    fontFamily: typography.sans, fontSize: 18, color: colors.fg3,
  },
  ...
  emptyTitle: {
    fontFamily: typography.serif, fontSize: 22, color: colors.fg,
