...
import {
  Briefcase, Navigation, MapPin, Clock, ChevronRight,
    ...
    >
      ...
      <View style={[s.topBar, { paddingTop: insets.top + 12 }]}>
        <View style={s.greeting}>
          ...
          <View>
            <Text style={s.dateEyebrow}>MON, 26 MAY</Text>
      ...
      <View style={s.statsStrip}>
        {[
          ...
          <View key={k} style={s.statCard}>
            <Text style={s.statEyebrow}>{k}</Text>
      ...
      <View style={s.activeJob}>
        <View style={s.activeJobInner}>
          <View style={s.activeJobHead}>
            <Text style={s.eyebrow}>[ACTIVE JOB] · #PC-2058</Text>
            <View style={s.badge}>
              <View style={[s.badgeDot, { backgroundColor: '#D9A441' }]} />
          ...
          <View style={s.activeJobActions}>
            ...
            >
              <Text style={s.primaryBtnText}>Start Job →</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
      ...
      <View style={s.sectionHead}>
        <Text style={s.eyebrow}>[UPCOMING TODAY] · 4 JOBS</Text>
      </View>
...
const s = StyleSheet.create({
  ...
  avatar: {
    width: 36, height: 36, borderRadius: 999, backgroundColor: colors.sage,
    alignItems: 'center', justifyContent: 'center',
  },
  avatarText: { fontFamily: typography.sansSemiBold, fontSize: 14, color: '#fff' },
  dateEyebrow: { fontFamily: typography.mono, fontSize: 9.5, color: colors.fg3, letterSpacing: 0.8, textTransform: 'uppercase' },
  greetingText: { fontFamily: typography.sansMedium, fontSize: typography.lg, color: colors.fg, letterSpacing: -0.2 },
  toggle: {
  ...
  toggleOn: { backgroundColor: 'rgba(91,111,82,0.18)', borderColor: 'rgba(91,111,82,0.5)' },
  dot: { width: 7, height: 7, borderRadius: 999 },
  dotOn: { backgroundColor: colors.success },
  dotOff: { backgroundColor: colors.fg3 },
  toggleText: { fontFamily: typography.mono, fontSize: 10, letterSpacing: 0.8, color: colors.fg2, textTransform: 'uppercase' },
  toggleTextOn: { color: '#fff' },

  statsStrip: {
    flexDirection: 'row', paddingHorizontal: spacing[5], gap: 8, marginTop: spacing[3],
  },
  statCard: {
    flex: 1, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.line,
    borderRadius: radii.md, padding: 12, gap: 6,
  },
  statEyebrow: { fontFamily: typography.mono, fontSize: 9.5, color: colors.fg3, letterSpacing: 0.8, textTransform: 'uppercase' },
  ...
  activeJobName: { fontFamily: typography.sansMedium, fontSize: 15, color: colors.fg },
  activeJobCar: { fontFamily: typography.sans, fontSize: 12, color: colors.fg2 },
  activeJobService: { fontFamily: typography.mono, fontSize: 10, color: colors.fg3, letterSpacing: 0.6, marginTop: 2 },
  activeJobAddress: {
  ...
  activeJobAddressText: { flex: 1, fontFamily: typography.sans, fontSize: 12, color: colors.fg2 },
  activeJobTime: { fontFamily: typography.mono, fontSize: 11, color: '#fff' },
  ...
  ghostBtnText: { fontFamily: typography.sansMedium, fontSize: 13, color: colors.fg, letterSpacing: 0.6 },
  primaryBtn: {
    flex: 2, backgroundColor: colors.warm, borderRadius: radii.pill,
    paddingVertical: 12, alignItems: 'center', justifyContent: 'center',
  },
  primaryBtnText: { fontFamily: typography.sansSemiBold, fontSize: 13, color: colors.ink, letterSpacing: 0.6 },
  ...
  upcomingTime: {
    ...
    borderRightWidth: 1, borderRightColor: colors.line, marginRight: 4,
  },
  upcomingTimeAmPm: { fontFamily: typography.mono, fontSize: 10, color: colors.fg3 },
  upcomingTimeHour: { fontFamily: typography.sansMedium, fontSize: typography.lg, color: colors.fg },
  upcomingInfo: { flex: 1 },
  upcomingName: { fontFamily: typography.sansMedium, fontSize: 13, color: colors.fg },
  upcomingCar: { fontFamily: typography.sans, fontSize: 11, color: colors.fg2 },
  upcomingService: { fontFamily: typography.mono, fontSize: 10, color: colors.fg3, letterSpacing: 0.6, marginTop: 2 },
});
